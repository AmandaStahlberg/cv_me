...
function clickAboutMe() {
    ...
    aboutMeFooter.onclick =  function() {youClickedAboutMe()}
}
...
function clickRefrences() {
    ...
    refrencesFooter.onclick =  function() {youClickedRefrences()}
}
...
function clickInterests() {
    ...
    interestsFooter.onclick =  function() {youClickedInterests()}
}
...
function clickTopButton() {
    ...
    topButton.onclick =  function() {youClickedTopButton()}
}
